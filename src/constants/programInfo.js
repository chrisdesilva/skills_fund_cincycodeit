...
export const schoolInfo = {
  ...
  APRRange36: "11.26 - 11.69%",
  APRRange60: "12.69 - 12.89%",
  interestOnly: [
    {
...
export const faq = {
  ...
  loanRange: [
    {
      programName:
        "MAX Technical Training's Full-Time .NET and Java Coding Bootcamps",
      maxAmount: "$14,000",
      col: true,
      colAmount: "$3,000",
    },
...
export const leadContent = {
  ...
  paragraph: `${schoolName} offers full-time and part-time .NET and Java programs to provide students a foundation for a career in software development. ${schoolName} partners with Skills Fund to offer tuition${
...
export const threeStepCardText = {
  ...
  step2: {
    ...
    text:
      "Choose between the Full-Time .NET Bootcamp, Full-Time Java Bootcamp, and Part-Time Java Bootcamp.",
  },
...
export const programLoanInfo = [
  ...
  {
    name: "Full-Time .NET",
    url: "https://my.skills.fund/application?lenderCode=SKCINNET17",
    loanInfo: {
  ...
  {
    name: "Full-Time Java",
    url: "https://my.skills.fund/application?lenderCode=SKCINJAV17",
    loanInfo: {
      // match loanInfo in first metro below
      maxLoanAmt: 17000,
      loanTerm36: true,
  ...
  {
    name: "Part-Time Java",
    url: "https://my.skills.fund/application?lenderCode=SKCINJAV18",
    loanInfo: {
      // match loanInfo in first metro below
      maxLoanAmt: 14000,
      loanTerm36: true,
...
export const programMaxText =
  "Choose the loan amount that works best for you. Borrow up to $14,000 for the full-time .NET and Java program tuition and up to $3,000 for cost of living, or up to $14,000 for the part-time Java program."
