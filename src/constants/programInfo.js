...
export const leadContent = {
	...
	paragraph: `${schoolName} offers full-time and part-time .NET and Java programs to provide students a foundation for a career in software development. ${schoolName} partners with Skills Fund to offer tuition${faq.costOfLiving
		? ' and cost of living'
